...
def process_textgrid(textgrid_files, max_prev):
    ...
    for tg_file in textgrid_files:
        ...
        for index, ele in enumerate(merge_data):
            segname = name + "--" + "%04d"%(index + 1)
            mint, maxt, text = ele['mint'], ele['maxt'], ele['text']
...
if __name__=="__main__":
    ...
    parser.add_argument("--data-dir",
                        "-d",
                        default="/data/duhu/datasets/alimeeting/",
                        type=str,

...
def write_tar_file(data_list,
    ...
    with tarfile.open(tar_file, "w") as tar:
        ...
        for item in data_list:
            key, wav, start, end = item['segname'], item['wav'], item['start'], item["end"]
            suffix = wav.split('.')[-1]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--json-file', default=None, help='json format file containing all information')
